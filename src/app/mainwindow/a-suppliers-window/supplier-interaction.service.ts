...
export class SupplierInteractionService {
  private supplier: Supplier[] = [
    { id: "S-001", supplierID: "18237823V", name: "apple12", email: "sugad89123@gmail.com", contact: "07161893612", drugsAvailable: "Dalcolx" },
    { id: "S-002", supplierID: "198273712V", name: "Huwawei Company", email: "su@gmail.com", contact: "071239121234", drugsAvailable: "Panadol" },
    { id: "S-003", supplierID: "987234233V", name: "Lalana Thanthirgama", email: "ken@gmail.com", contact: "0773247673", drugsAvailable: "Citacins" },
    { id: "S-004", supplierID: "198198917V", name: "GlaxoSmithKline", email: "info@gsk.com", contact: "0372266348", drugsAvailable: "Metformin" }
  ];
  ...
  getSupplier() {
    ...
    .pipe(map(supplierData => {
     if (!supplierData || !supplierData.suppliers || supplierData.suppliers.length === 0) return [];
    ...
    .subscribe({
      next: (transformedSuppliers) => {
        if (transformedSuppliers && transformedSuppliers.length > 0) {
