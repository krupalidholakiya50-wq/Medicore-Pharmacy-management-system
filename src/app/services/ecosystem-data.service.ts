...
export class EcosystemDataService {
  ...
  private initialInventory: InventoryItem[] = [
    { id: 'INV-101', drugName: 'Panadol', name: 'Panadol', batchId: 'PND-2026A', supplier: 'Krupali Dholakiya', email: 'krupali@gmail.com', quantity: 2960, expiryDate: '2028-12-15', expireDate: '2028-12-15', price: 1200, imagePath: 'assets/img/panadol.jpg' },
    { id: 'INV-102', drugName: 'Citazin', name: 'Citazin', batchId: 'CTZ-2026B', supplier: 'Janvi Ramani', email: 'janvi.ramani@gmail.com', quantity: 148, expiryDate: '2027-06-20', expireDate: '2027-06-20', price: 1200, imagePath: 'assets/img/citazin.jpg' },
    { id: 'INV-103', drugName: 'Metformin', name: 'Metformin', batchId: 'MET-2026C', supplier: 'Sejal Gond', email: 'sejal.gond@gmail.com', quantity: 9791, expiryDate: '2029-03-10', expireDate: '2029-03-10', price: 1200, imagePath: 'assets/img/metformin.jpg' },
    { id: 'INV-104', drugName: 'Amoxillin', name: 'Amoxillin', batchId: 'AMX-2026D', supplier: 'Janvi Ramani', email: 'janvi.ramani@gmail.com', quantity: 5, expiryDate: '2028-09-05', expireDate: '2028-09-05', price: 1200, imagePath: 'assets/img/amoxillin.jpg' },
    { id: 'INV-105', drugName: 'Demo1', name: 'Demo1', batchId: 'DEM-2026E', supplier: 'Sejal Gond', email: 'sejal.gond@gmail.com', quantity: 4, expiryDate: '2026-11-18', expireDate: '2026-11-18', price: 1201, imagePath: 'assets/img/demo1.jpg' },
    { id: 'INV-106', drugName: 'Chloroperi Hybanate', name: 'Chloroperi Hybanate', batchId: 'CPH-2026F', supplier: 'Krupali Dholakiya', email: 'krupali@gmail.com', quantity: 3423, expiryDate: '2026-08-12', expireDate: '2026-08-12', price: 1200, imagePath: 'assets/img/chloroperi.jpg' }
  ];
  ...
  deductStock(drugName: string, quantityDeducted: number): void {
    ...
    const updated = current.map(item => {
      if (item.drugName.toLowerCase() === drugName.toLowerCase() || item.name?.toLowerCase() === drugName.toLowerCase()) {
        const newQty = Math.max(0, item.quantity - quantityDeducted);
